...
After significant changes (new features, architecture decisions, schema changes), save context to Agent-MCP using `update_project_context`. Use the key prefix `exercise-tracker-refactor-app/` (e.g., `exercise-tracker-refactor-app/architecture`).
