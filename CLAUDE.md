...
After significant changes (new features, architecture decisions, schema changes), save context to Agent-MCP using `update_project_context`. Use the key prefix `exercise-tracker-pr-confirmed/` (e.g., `exercise-tracker-pr-confirmed/architecture`).
