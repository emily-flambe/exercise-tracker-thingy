...
export function showLoginForm(): void {
  ...
  $('auth-login-tab').classList.add('border-warm-primary', 'text-warm-primary');
  $('auth-login-tab').classList.remove('border-warm-border', 'text-warm-text-secondary');
  $('auth-register-tab').classList.remove('border-warm-primary', 'text-warm-primary');
  $('auth-register-tab').classList.add('border-warm-border', 'text-warm-text-secondary');
...
export function showRegisterForm(): void {
  isRegisterMode = true;
  $('auth-register-tab').classList.add('border-warm-primary', 'text-warm-primary');
  $('auth-register-tab').classList.remove('border-warm-border', 'text-warm-text-secondary');
  $('auth-login-tab').classList.remove('border-warm-primary', 'text-warm-primary');
  $('auth-login-tab').classList.add('border-warm-border', 'text-warm-text-secondary');
